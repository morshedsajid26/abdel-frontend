  ...
  return (
    <div className="bg-[#ffffff] p-6 rounded-xl border border-[#cccccc] relative">
      <div className="text-center mb-6">
        <h2 className="text-lg font-medium text-[#0e1217] mb-2">Upload doc pdf file</h2>
      ...
      >
        ...
        {files.length > 0 ? (
          ...
          <>
            ...
            <button className="px-8 py-2 rounded-full border border-[#419977] bg-linear-to-t from-[#173623] via-[#0a170f] to-[#11291b] text-sm text-white shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_20px_rgba(37,99,235,0.5)] transition-all pointer-events-none">
              Upload Files
            </button>
          </>
        )}
